...
import {
    ...
    animate as animate19,
    animate as animate20,
    animate as animate21,
    animate as animate22,
    animate as animate23,
    animate as animate24,
    animateSequence,
    animateSequence as animateSequence2,
    animateSequence as animateSequence3,
    animateSequence as animateSequence4,
    animateSequence as animateSequence5,
    animateSequence as animateSequence6,
    animateSequence as animateSequence7,
    animateSequence as animateSequence8,
    animateSequence as animateSequence9,
    animateSequence as animateSequence10,
    animateSequence as animateSequence11,
    animateSequence as animateSequence12,
    animateSequence as animateSequence13,
    animateSequence as animateSequence14,
    animateSequence as animateSequence15,
    Delegate,
    ...
    Delegate as Delegate9,
    Delegate as Delegate10,
    Delegate as Delegate11,
    FocusTrap,
    frame,
    frame as frame2,
    inView,
...
// js/common/animation/marquee-text.js
var _resizeObserver, _currentAnimation, _MarqueeText_instances, isVertical_get, direction_get, scroller_get,
    initializeShadowDom_fn, createElements_fn;
...
var _abortController, _scheduleSizeRecalculation, _parentBoundingClientReact, _clientWidth, _clientHeight,
    _CustomCursor_instances, onPointerLeave_fn, onPointerMove_fn, precomputeDimensions_fn, calculateCoordinates_fn;
...
onPointerMove_fn = function (event) {
    ...
    } = __privateMethod(this, _CustomCursor_instances, calculateCoordinates_fn).call(this, event);
...
calculateCoordinates_fn = function (event) {
    ...
    const parentBoundingRect = __privateGet(this, _parentBoundingClientReact),
    ...
    const mouseY = event.clientY - parentBoundingRect.y - __privateGet(this, _clientHeight) / 2,
        mouseX = event.clientX - parentBoundingRect.x - __privateGet(this, _clientWidth) / 2;
...
var _callback, _duration, _remainingTime, _startTime, _timer, _state, _onVisibilityChangeListener,
    _mustResumeOnVisibility, _Player_instances, onVisibilityChange_fn;
...
var _resizeObserver3, _checkPositionListener, _initialTop, _lastKnownY, _currentTop, _position, _SafeSticky_instances,
...
split_fn = function (force = false) {
    ...
    this.dispatchEvent(new CustomEvent("split-lines:split", {
        bubbles: true,
        detail: {lines: Array.from(this.shadowRoot.children)}
    }));
};
...
var _hasPendingProgrammaticScroll, _onMouseDownListener, _onMouseMoveListener, _onMouseClickListener,
    _onMouseUpListener, _targetIndex, _forceChangeEvent, _dragPosition, _isDragging, _dispatchableScrollEvents,
    _scrollTimeout, _ScrollCarousel_instances, setupListeners_fn, updateTargetIndex_fn, onScroll_fn, onScrollEnd_fn,
    calculateLeftScroll_fn, calculateClosestIndexToAlignment_fn, onMouseDown_fn, onMouseMove_fn, onMouseClick_fn,
    onMouseUp_fn, onResize_fn, onMutate_fn, adaptHeight_fn, preloadImages_fn;
...
onScroll_fn = function () {
    const scrollEdgeThreshold = 100,
        normalizedScrollLeft = Math.round(Math.abs(this.scrollLeft - Math.abs(parseInt(getComputedStyle(this).marginInlineStart) || 0)));
...
onMouseUp_fn = function (event) {
    ...
    if (event.clientX - __privateGet(this, _dragPosition).x === 0) {
        ...
        this.scrollTo({
            left: __privateMethod(this, _ScrollCarousel_instances, calculateLeftScroll_fn).call(this, this.selectedCell),
            behavior: "smooth"
        });
    }
    this.removeEventListener("mousemove", __privateGet(this, _onMouseMoveListener));
...
var CarouselDirectionButton = class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        __privateGet(this, _mutationObserver).observe(this.carousel, {
            attributes: true,
...
var _listenersAbortController, _gestureArea, _player, _targetIndex2, _preventInitialTransition, _hasPendingTransition,
    _EffectCarousel_instances, setupListeners_fn2, onKeyboardNavigation_fn, preloadImages_fn2;
...
changeLineItemQuantity_fn = async function (lineKey, targetQuantity) {
    ...
    if (!response.ok) {
        const responseContent = responseJson
...
var _estimateShippingListener, _ShippingEstimator_instances, estimateShipping_fn, getAsyncShippingRates_fn,
    formatShippingRates_fn, formatError_fn;
...
var _isLocked, _delegate2, _focusLeaveDelegate, _abortController5, _focusTrap, _isTransitioningToState,
    _originalParentBeforeAppend, _DialogElement_instances, allowOutsideClick_fn, allowOutsideClickTouch_fn,
    allowOutsideClickMouse_fn, onActivatorClicked_fn, onActivatorPointerEnter_fn, updateSlotVisibility_fn;
...
var Drawer = class extends DialogElement {
    ...
    createEnterAnimationControls() {
        ...
        return animateSequence2([
            ...
            [this.getShadowPartByName("content"), {opacity: [0, 1], transform: contentTransform}, {
                duration: 0.45,
                at: "-0.15",
                ease: [0.86, 0, 0.07, 1]
            }]
    ...
    createLeaveAnimationControls() {
        ...
        return animateSequence2([
            ...
            [this.getShadowPartByName("content"), {opacity: [1, 0], transform: contentTransform}, {
                duration: 0.45,
                at: "<",
                ease: [0.86, 0, 0.07, 1]
            }]
...
var DrawerPopover = class extends DialogElement {
    ...
    createEnterAnimationControls() {
        return animateSequence3([
            ...
            }, {duration: 0.45, at: "-0.15", ease: [0.86, 0, 0.07, 1]}]
        ]);
    }
    ...
    createLeaveAnimationControls() {
        return animateSequence3([
            ...
            }, {duration: 0.45, at: "<", ease: [0.86, 0, 0.07, 1]}]
        ]);
    }
};
...
var Popover = class extends DialogElement {
    ...
    createEnterAnimationControls() {
        ...
        if (matchesMediaQuery("md-max")) {
            return animateSequence5([
                [this.getShadowPartByName("overlay"), {opacity: [0, 1]}, {
                    duration: 0.3,
                    ease: [0.645, 0.045, 0.355, 1]
                }],
                [this.getShadowPartByName("content"), {transform: ["translateY(100%)", "translateY(0)"]}, {
                    duration: 0.3,
                    at: "<",
                    ease: [0.645, 0.045, 0.355, 1]
                }]
    ...
    createLeaveAnimationControls() {
        if (matchesMediaQuery("md-max")) {
            return animateSequence5([
                [this.getShadowPartByName("overlay"), {opacity: [1, 0]}, {
                    duration: 0.3,
                    ease: [0.645, 0.045, 0.355, 1]
                }],
                [this.getShadowPartByName("content"), {transform: ["translateY(0%)", "translateY(100%)"]}, {
                    duration: 0.3,
                    at: "<",
                    ease: [0.645, 0.045, 0.355, 1]
                }]
...
document.addEventListener("facet:update", async (event) => {
    ...
    try {
        ...
        const scrollToProductList = () => shopifySection.querySelector(event.detail.scrollTo)?.scrollIntoView({
            block: "start",
            behavior: "smooth"
        });
...
onShow_fn = function (event) {
    ...
    animate6(messageElement, {opacity: [0, 1], transform: ["translateY(20px)", "translateY(0)"]}, {
        duration: 0.25,
        ease: "easeInOut"
    });
    setTimeout(async () => {
        await animate6(messageElement, {opacity: [1, 0], transform: ["scale(1)", "scale(0.85)"]}, {
            duration: 0.25,
            ease: "easeInOut"
        });
...
var _abortController6, _decreaseButton, _increaseButton, _inputElement, _QuantitySelector_instances,
    onDecreaseQuantity_fn, onIncreaseQuantity_fn, updateUI_fn;
...
onSwatchChanged_fn = async function (event, target) {
    ...
    let newMedia = JSON.parse(target.getAttribute("data-variant-media")),
        ...
        newPrimaryMediaElement = __privateMethod(this, _ProductCard_instances, createMediaImg_fn).call(this, newMedia, primaryMediaElement.className, primaryMediaElement.sizes),
...
var _abortController8, _photoSwipeInstance, _onGestureChangedListener, _settledMedia, _ProductGallery_instances,
    registerLightboxUi_fn, onSectionRerender_fn, onVariantChange_fn, onMediaChange_fn, onMediaSettle_fn,
    onCarouselClick_fn, onGestureStart_fn, onGestureChanged_fn;
...
var OpenLightBoxButton = class extends HTMLElement {
    constructor() {
        ...
        this.addEventListener("click", () => this.dispatchEvent(new CustomEvent("lightbox:open", {
            bubbles: true,
            detail: {index: this.hasAttribute("image-index") ? parseInt(this.getAttribute("image-index")) : null}
        })));
    }
};
...
var ProductList = class extends ScrollCarousel {
    ...
    async reveal() {
        animate7(this.querySelectorAll('product-card[reveal-on-scroll="true"], .product-list__promo[reveal-on-scroll="true"]'), {
            ...
            duration: 0.1,
            ease: "easeInOut",
            delay: window.themeVariables.settings.staggerProducts ? stagger(0.05, {
                startDelay: 0.1,
                ease: "easeOut"
            }) : 0
        });
...
var _preloadedHtml, _delegate4, _intersectionObserver2, _form, _selectedVariant, _VariantPicker_instances,
...
var _detailsElement, _summaryElement, _contentElement, _AccordionDisclosure_instances, onSummaryClick_fn, open_fn,
    close_fn;
var AccordionDisclosure = class extends HTMLElement {
    ...
    createOpenAnimationControls() {
        return animateSequence6([
            [__privateGet(this, _detailsElement), {height: [`${__privateGet(this, _summaryElement).clientHeight}px`, `${__privateGet(this, _detailsElement).clientHeight}px`]}, {
                duration: 0.25,
                ease: "easeInOut"
            }],
            [__privateGet(this, _contentElement), {
                opacity: [0, 1],
    ...
    createCloseAnimationControls() {
        return animateSequence6([
            ...
            [__privateGet(this, _detailsElement), {height: [`${__privateGet(this, _detailsElement).clientHeight}px`, `${__privateGet(this, _summaryElement).clientHeight}px`]}, {
                duration: 0.25,
                at: "<",
                ease: "easeInOut"
            }]
...
var _componentID, _buttons, _panels, _delegate5, _Tabs_instances, setupComponent_fn, onButtonClicked_fn,
    onSlotChange_fn, handleKeyboard_fn;
    ...
    set selectedIndex(index) {
        ...
        __privateGet(this, _buttons).forEach((button, i) => {
            if (i === index) {
                ...
                this.scrollTo({
                    left: button.offsetLeft - this.clientWidth / 2 + button.clientWidth / 2,
                    behavior: "smooth"
                });
            } else {
                button.tabIndex = -1;
...
var _delegate6, _listenersAbortController2, _fetchAbortController, _searchForm, _queryInput,
    _PredictiveSearch_instances, onInputChanged_fn, onFormSubmitted_fn2, doPredictiveSearch_fn, onSearchCleared_fn;
...
doPredictiveSearch_fn = async function () {
    ...
    try {
        const url = `${window.Shopify.routes.root}search${this.supportsPredictiveApi() ? "/suggest" : ""}`,
            ...
            tempDoc = new DOMParser().parseFromString(await (await cachedFetch(`${url}?${queryParams}`, {signal: __privateGet(this, _fetchAbortController).signal})).text(), "text/html");
...
var _isLoading, _ButtonContent_instances, startHoverEffect_fn, finishHoverEffect_fn, onObserveAttributes_fn,
    onLoadingChanged_fn;
var ButtonContent = class extends HTMLElement {
    constructor() {
        ...
        mutationObserver.observe(this.parentElement, {
            attributes: true,
    ...
    if (loading) {
        ...
        if (__privateGet(this, _isLoading)) {
            animateSequence7([
                ...
                [transientContent, {
                    transform: ["translate(-50%, calc(-50% + 10px))", "translate(-50%, -50%)"],
                    opacity: [0, 1]
                }, {duration: 0.18}]
            ]);
        }
        ...
        animateSequence7([
            [transientContent, {
                transform: ["translate(-50%, -50%)", "translateY(-50%, calc(-50% + 10px))"],
                opacity: [1, 0]
            }, {duration: 0.18}],
...
var _hasRevealed, _HighlightedHeading_instances, effect_get, showAnimation_get, onBecameVisible_fn, doTransition_fn,
    onSplit_fn;
...
switchForm_fn = async function () {
    const fromForm = window.location.hash === "#recover" ? __privateGet(this, _AccountLogin_instances, loginForm_get) : __privateGet(this, _AccountLogin_instances, recoverForm_get),
        toForm = window.location.hash === "#recover" ? __privateGet(this, _AccountLogin_instances, recoverForm_get) : __privateGet(this, _AccountLogin_instances, loginForm_get);
    await animate10(fromForm, {opacity: [1, 0], transform: ["translateY(0)", "translateY(-10px)"]}, {
        duration: 0.25,
        ease: "easeInOut"
    });
    fromForm.hidden = true;
    toForm.hidden = false;
    await animate10(toForm, {opacity: [0, 1], transform: ["translateY(10px)", "translateY(0)"]}, {
        duration: 0.25,
        ease: "easeInOut"
    });
};
    ...
    createOnChangeAnimationControls(fromSlide, toSlide) {
        return {
            leaveControls: () => animate11(fromSlide, {
                opacity: [1, 0],
                transform: ["translateY(0)", "translateY(-10px)"]
            }, {duration: 0.25, ease: [0.55, 0.055, 0.675, 0.19]}),
            enterControls: () => animate11(toSlide, {
                opacity: [0, 1],
                transform: ["translateY(10px)", "translateY(0px)"]
            }, {duration: 0.4, ease: [0.215, 0.61, 0.355, 1]})
        };
    }
};
...
var _onPointerMoveListener, _touchStartTimestamp, _BeforeAfter_instances, onPointerDown_fn, onPointerMove_fn2,
    onTouchStart_fn, onPointerUp_fn, onKeyboardNavigation_fn2, calculatePosition_fn, animateInitialPosition_fn;
...
animateInitialPosition_fn = function () {
    if (CSS.registerProperty) {
        animate12(this, {"--before-after-cursor-position": "var(--before-after-initial-cursor-position)"}, {
            duration: 0.6,
            ease: [0.85, 0, 0.15, 1]
        });
    } else {
...
var _sectionId, _CartDrawer_instances, onBundleSection_fn, onCartChange_fn, onPageShow_fn, refreshCart_fn,
    replaceContent_fn;
...
onCartChange_fn = function (event) {
    const html = new DOMParser().parseFromString(event.detail.cart["sections"][__privateGet(this, _sectionId)], "text/html"),
        itemCount = event.detail.cart["item_count"],
        newCartDrawer = document.createRange().createContextualFragment(html.getElementById(`shopify-section-${__privateGet(this, _sectionId)}`).querySelector("cart-drawer").innerHTML);
    if (itemCount === 0) {
...
var CountdownTimerFlipDigit = class extends HTMLElement {
    ...
    async attributeChangedCallback(name, oldValue, newValue) {
        ...
        await animate14(this.shadowRoot.firstElementChild, {transform: ["translateY(0)", "translateY(-50%)"]}, {
            duration: 0.3,
            ease: [0.36, 0, 0.66, -0.56]
        });
        this.textContent = newValue;
        animate14(this.shadowRoot.firstElementChild, {transform: ["translateY(100%)", "translateY(0px)"]}, {
            duration: 0.2,
            ease: [0.22, 1, 0.36, 1]
        });
    }
...
var _headerTrackerIntersectionObserver, _abortController10, _scrollYTrackingPosition, _isVisible2, _Header_instances,
    onHeaderTrackerIntersection_fn, detectMousePosition_fn, detectScrollDirection_fn, setVisibility_fn;
var Header = class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        if (this.hasAttribute("hide-on-scroll")) {
            window.addEventListener("scroll", throttle(__privateMethod(this, _Header_instances, detectScrollDirection_fn).bind(this)), {
...
var HeaderDropdownMenu = class extends DialogElement {
    ...
    createEnterAnimationControls() {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push([this.querySelectorAll(":scope > ul > li"), {
                opacity: [0, 1],
                transform: ["translateY(0.8em)", "translateY(0)"]
            }, {duration: 0.1, at: "-0.1", delay: stagger3(0.05), ease: "easeInOut"}]);
        }
...
var HeaderMegaMenu = class extends DialogElement {
    createEnterAnimationControls() {
        ...
        if (links.length > 0 && window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push(
                [links, {opacity: [0, 1], transform: ["translateY(1em)", "translateY(0)"]}, {
                    duration: 0.2,
                    at: "-0.1",
                    delay: stagger3(0.05),
                    ease: "easeInOut"
                }],
                [this.querySelectorAll(".menu-promo"), {opacity: [0, 1]}, {
                    duration: 0.3,
                    at: "-0.1",
                    ease: "easeInOut"
                }]
...
var _delegate7, _isTransitioningPanel, _HeaderMenuDrawer_instances, onBeforeShow_fn, onAfterHide_fn2,
    onSwitchToPanel_fn, calculateOffsets_fn;
var HeaderMenuDrawer = class extends DialogElement {
    ...
    createEnterAnimationControls() {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push(
                [this.getShadowPartByName("content"), {transform: ["translateX(calc(var(--transform-logical-flip) * -100%))", "translateX(0)"]}, {
                    duration: 0.35,
                    at: "<",
                    ease: [0.2, 0.4, 0.2, 1]
                }]
    ...
    createLeaveAnimationControls() {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push(
                [this.shadowRoot.querySelector("slot").assignedElements(), {opacity: [1, 0]}, {
                    duration: 0.15,
                    ease: "easeInOut",
                    at: "<"
                }],
                [this.getShadowPartByName("content"), {transform: ["translateX(0)", "translateX(calc(var(--transform-logical-flip) * -100%))"]}, {
                    duration: 0.25,
                    ease: [0.645, 0.045, 0.355, 1]
                }]
            );
...
var HeaderMenuDrawerPanel = class extends HTMLElement {
    async show({initial = true} = {}) {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            ...
            if (initial) {
                return animateSequence8([
                    [this.querySelectorAll(".menu-drawer__panel-body > *"), {
                        opacity: [0, 1],
                        transform: ["translateY(1em)", "translateY(0)"]
                    }, {duration: 0.2, delay: stagger3(0.1, {startDelay: 0.4})}],
                    [this.querySelector(".menu-drawer__panel-footer"), {
                        opacity: [0, 1],
                        transform: ["translateY(1em)", "translateY(0)"]
                    }, {duration: 0.2, at: "-0.1", ease: "easeInOut"}]
                ]);
            } else {
                if (this.hasAttribute("data-main-panel")) {
                    return animateSequence8([
                        [this, {
                            background: ["rgb(0 0 0 / 0.15)", "rgb(0 0 0 / 0)"],
                            transform: [`translateX(${-30 * rtlFlip}%)`, "translateX(0)"]
                        }, {duration: 0.25, ease: "easeInOut"}]
                    ]);
                } else {
                    return animateSequence8([
                        [this, {transform: [`translateX(${rtlFlip * 100}%)`, "translateX(0)"]}, {
                            duration: 0.4,
                            ease: [0.645, 0.045, 0.355, 1]
                        }]
                    ]);
            ...
            if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
                ...
                if (this.hasAttribute("data-main-panel")) {
                    promise = animateSequence8([
                        [this, {
                            background: ["rgb(0 0 0 / 0)", "rgb(0 0 0 / 0.15)"],
                            transform: ["translateX(0)", `translateX(${-30 * rtlFlip}%)`]
                        }, {duration: 0.4, ease: [0.645, 0.045, 0.355, 1]}]
                    ]);
                } else {
                    promise = animateSequence8([
                        [this, {transform: ["translateX(0%)", `translateX(${100 * rtlFlip}%)`]}, {
                            duration: 0.25,
                            ease: "easeInOut"
                        }]
                    ]);
...
var _delegate8, _HeaderMenuDropdownSidebar_instances, onBeforeShow_fn2, onAfterHide_fn3, onFirstLevelClicked_fn,
    selectSidebarPosition_fn, calculateOffsets_fn2;
var HeaderMenuDropdownSidebar = class extends DialogElement {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push(
                ...
                [this.querySelectorAll(".menu-drawer__panel-body"), {
                    opacity: [0, 1],
                    transform: ["translateY(1em)", "translateY(0)"]
                }, {duration: 0.2, delay: stagger3(0.1)}],
                [this.querySelector(".menu-drawer__panel-footer"), {
                    opacity: [0, 1],
                    transform: ["translateY(1em)", "translateY(0)"]
                }, {duration: 0.2, at: "-0.1", ease: "easeInOut"}]
    ...
    createLeaveAnimationControls() {
        ...
        if (window.matchMedia("(prefers-reduced-motion: no-preference)").matches) {
            timelineSteps.push(
                [this.querySelectorAll(".menu-drawer__panel-body, .menu-drawer__panel-footer"), {opacity: [1, 0]}, {
                    duration: 0.15,
                    ease: "easeInOut",
                    at: "<"
                }],
...
selectSidebarPosition_fn = async function (position) {
    ...
    if (selectedSidebarLevel && position) {
        ...
        await animate15(selectedSidebarLevel, {
            opacity: [1, 0],
            height: [`${selectedSidebarLevel.clientHeight}px`, `${toHeight}px`]
...
onItemChange_fn = function (item, transition = true) {
    ...
    if (toImage) {
        animate16(this.querySelectorAll(`.featured-links__cursor-image:not([data-block-id="${item.getAttribute("data-block-id")}"])`), {opacity: 0}, {
            duration: transition ? 0.15 : 0,
            ease: "easeInOut"
        });
...
onItemChange_fn2 = function (item, transition = true) {
    ...
    if (toImage) {
        animate17(this.querySelectorAll(`[data-image-block-id]:not([data-image-block-id="${item.getAttribute("data-block-id")}"])`), {opacity: 0}, {
            duration: transition ? 0.15 : 0,
            ease: "easeInOut"
        });
...
var LinksWithImageCarousel = class extends EffectCarousel {
    createOnChangeAnimationControls(fromSlide, toSlide) {
        ...
        if (toImage) {
            animate17(this.parentElement.querySelectorAll(`[data-image-block-id]:not([data-image-block-id="${toSlide.getAttribute("data-block-id")}"])`), {
                opacity: 0,
                visibility: "hidden"
            }, {duration: 0.25, delay: 0.1, ease: "easeInOut"});
            animate17(toImage, {opacity: 1, visibility: "visible"}, {duration: 0.25, delay: 0.1, ease: "easeInOut"});
        }
        return animateSequence9([
            [fromSlide, {opacity: 0, transform: [null, "translateY(-10px)"]}, {
                duration: 0.35,
                ease: [0.55, 0.055, 0.675, 0.19]
            }],
            [toSlide, {opacity: 1, transform: ["translateY(10px)", "translateY(0)"]}, {
                duration: 0.35,
                at: "+0.2",
...
var NewsModal = class extends Modal {
    ...
    createEnterAnimationControls() {
        return animate19(this.getShadowPartByName("content"), {
            opacity: [0, 1],
            transform: ["translateY(-40px)", "translateY(0)"]
        }, {duration: 0.15, ease: [0.86, 0, 0.07, 1]});
    }
...
show_fn = function ({animatePanel = true} = {}) {
    ...
    const animation = animateSequence10([
        ...
        }, {duration: 0.3, ease: [0.86, 0, 0.07, 1]}],
        [__privateGet(this, _newsModalContent), {height: [__privateGet(this, _initialHeight) + "px", Math.max(__privateGet(this, _initialHeight), this.scrollHeight / 1.3) + "px"]}, {
            duration: 0.3,
            ease: [0.86, 0, 0.07, 1],
            at: "<"
        }]
...
hide_fn = function () {
    const animation = animateSequence10([
        ...
        [__privateGet(this, _newsModalContent), {height: [Math.max(__privateGet(this, _initialHeight), this.scrollHeight / 1.3) + "px", __privateGet(this, _initialHeight) + "px"]}, {
            duration: 0.3,
            ease: [0.86, 0, 0.07, 1],
            at: "<"
        }]
...
var PressCarousel = class extends EffectCarousel {
    createOnBecameVisibleAnimationControls(toSlide) {
        if (toSlide.hasAttribute("reveal-on-scroll") && toSlide.getAttribute("reveal-on-scroll") === "true") {
            return animate20(toSlide, {
                opacity: [0, 1],
                transform: ["translateY(1em)", "translateY(0)"]
            }, {duration: 0.5, delay: 0.25, ease: [0.25, 0.46, 0.45, 0.94]});
        }
    ...
    createOnChangeAnimationControls(fromSlide, toSlide) {
        return animateSequence11([
            [fromSlide, {opacity: [1, 0], transform: ["translateY(0)", "translateY(-1em)"]}, {
                duration: 0.5,
                ease: [0.55, 0.055, 0.675, 0.19]
            }],
            [toSlide, {opacity: [0, 1], transform: ["translateY(1em)", "translateY(0)"]}, {
                duration: 0.5,
                at: "+0.2",
                ease: [0.25, 0.46, 0.45, 0.94]
            }]
...
var _resizeObserver4, _enterEffectDone, _ReadingText_instances, textStartOpacity_get, lines_get, chars_get,
    animatableElements_get, setupEffect_fn, showEnterEffect_fn, showLeaveEffect_fn, startLettersAnimation_fn,
    calculateScrollingHeight_fn;
    ...
    if (!__privateGet(this, _enterEffectDone)) {
        ...
        if (this.querySelector(".button")) {
            timelineSteps.push([
                ...
                {
                    opacity: [0, __privateGet(this, _ReadingText_instances, textStartOpacity_get)],
                    transform: ["translateY(1em)", "translateY(0)"]
                },
...
var _navigationButtonAnimationControls, _completedHighlightedHeadings, _Slideshow_instances, effect_get2,
    onSlideChange_fn, onPlayerStart_fn2, onPlayerStop_fn, onPlayerPause_fn, onPlayerResume_fn;
        ...
        switch (__privateGet(this, _Slideshow_instances, effect_get2)) {
            ...
            case "vertical_reveal":
                ...
                animationControls = animateSequence13([
                    [fromSlide, {transform: ["translateY(0)", `translateY(${flip * -100}%)`]}, {
                        duration: 0.3,
                        ease: [0.55, 0.085, 0.68, 0.53],
                        at: 0
                    }],
                    [fromSlide.firstElementChild, {transform: ["translateY(0)", `translateY(${flip * 75}%)`]}, {
                        duration: 0.3,
                        ease: [0.55, 0.085, 0.68, 0.53],
                        at: 0
                    }],
                    {name: "middle", at: "+0.1"},
                    [toSlide, {
                        transform: [`translateY(${flip * 100}%)`, "translateY(0)"],
                        opacity: [1, 1]
                    }, {duration: 0.7, ease: [0.19, 1, 0.22, 1], at: "middle"}],
                    [toSlide.firstElementChild, {transform: [`translateY(${flip * -75}%)`, "translateY(0)"]}, {
                        duration: 0.7,
                        ease: [0.19, 1, 0.22, 1],
                        at: "middle"
                    }]
            ...
            case "curtain":
                flip = direction === "next" ? document.dir === "rtl" ? -1 : 1 : document.dir === "rtl" ? 1 : -1;
                animationControls = animateSequence13([
                    [fromSlide, {transform: ["translateX(0)", `translateX(${flip * -100}%)`]}, {
                        ease: [0.77, 0, 0.175, 1],
                        at: 0
                    }],
                    [fromSlide.firstElementChild, {transform: ["translateX(0)", `translateX(${flip * 30}%)`]}, {
                        ease: [0.77, 0, 0.175, 1],
                        at: 0
                    }],
                    [toSlide, {transform: [`translateX(${flip * 100}%)`, "translateX(0)"]}, {
                        ease: [0.77, 0, 0.175, 1],
                        at: 0
                    }],
                    [toSlide.firstElementChild, {transform: [`translateX(${flip * -30}%)`, "translateX(0)"]}, {
                        ease: [0.77, 0, 0.175, 1],
                        at: 0
                    }]
                ], {
            ...
            case "distortion":
                ...
                animationControls = animateSequence13([
                    ...
                    [fromSlide.firstElementChild, {transform: ["scaleX(1)", "scaleX(2.5)"]}, {
                        ease: [0.645, 0.045, 0.355, 1],
                        at: 0
                    }],
                    [toSlide, {transform: [`translateX(${flip * 100}%)`, "translateX(0)"]}, {
                    ...
                    [toSlide.firstElementChild, {transform: [`translateX(${flip * -100}%) scaleX(2.5)`, "translateX(0) scaleX(1)"]}, {
                        ease: [0.645, 0.045, 0.355, 1],
                        at: 0
                    }]
                ], {
            ...
            case "perspective":
                animationControls = animateSequence13([
                    [fromSlide, {transform: ["scale(1)", "scale(0.9)"], opacity: [1, 0.3]}, {
                        duration: 0.15,
                        ease: [0.445, 0.05, 0.55, 0.95]
                    }],
                    {name: "middle", at: "+0.1"},
                    [fromSlide, {
                        transform: ["translateY(0) scale(0.9)", `translateY(-20%) scale(0.9)`],
                        opacity: [0.3, 0]
                    }, {at: "middle", ease: [0.77, 0, 0.175, 1]}],
                    [toSlide, {
                        transform: [`translateY(100%) scale(1)`, `translateY(0) scale(1)`],
                        opacity: [1, 1]
                    }, {at: "middle", ease: [0.77, 0, 0.175, 1]}],
                    [toSlide.firstElementChild, {transform: [`translateY(-50%)`, "translateY(0)"]}, {
                        at: "middle",
                        ease: [0.77, 0, 0.175, 1]
                    }]
                ], {
            ...
            case "scale_down":
                flip = direction === "next" ? document.dir === "rtl" ? -1 : 1 : document.dir === "rtl" ? 1 : -1;
                animationControls = animateSequence13([
                    [fromSlide, {opacity: [1, 0], transform: ["scale(1)", `scale(0.7)`]}, {
                        duration: 0.5,
                        ease: [0.645, 0.045, 0.355, 1],
                        at: 0
                    }],
                    [toSlide, {
                        opacity: [1, 1],
                        transform: [`translateY(${flip * 100}%)`, "translateY(0)"]
                    }, {duration: 0.7, ease: [0.645, 0.045, 0.355, 1], at: "<"}]
                ]);
                break;
        }
...
var TestimonialsCarousel = class extends EffectCarousel {
    createOnChangeAnimationControls(fromSlide, toSlide, {direction} = {}) {
        ...
        if (toInfo && toInfo) {
            ...
            animate24(toInfo, {opacity: [0, 1], visibility: ["hidden", "visible"]}, {
                duration: 0.25,
                delay: 0.1,
                ease: "easeInOut"
            });
        ...
        return animateSequence14([
            ...
            }, {duration: 0.3, at: 0, ease: [0.55, 0.055, 0.675, 0.19]}],
            [toSlide, {
                visibility: ["hidden", "visible"],
                opacity: [0, 1],
                transform: ["translateY(1em)", "translateY(0)"]
            }, {duration: 0.5, at: "+0.2", ease: [0.25, 0.46, 0.45, 0.94]}]
        ]);
    }
};
...
var Timeline = class extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.addEventListener("shopify:block:select", (event) => this.select({
    ...
    async select({blockId, instant = false} = {}) {
        ...
        if (toPicture && fromPicture !== toPicture) {
            ...
            timelineSteps.push(
                ...
                }, {duration: 0.5, at: "<", delay: 0.2, ease: [0.4, 0, 0.2, 1]}]
            );
        }
        timelineSteps.push(
            [fromContent, {
